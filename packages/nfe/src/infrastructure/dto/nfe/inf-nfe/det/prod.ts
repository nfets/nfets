...
import { Prod as IProd } from '@nfets/nfe/domain/entities/nfe/inf-nfe/det/prod';
import { TransformDecimal } from '@nfets/core/application';
import { Type } from 'class-transformer';
import type { DI as IDI } from '@nfets/nfe/domain/entities/nfe/inf-nfe/det/di';
import type { DetExport as IDetExport } from '@nfets/nfe/domain/entities/nfe/inf-nfe/det/det-export';
import type { Rastro as IRastro } from '@nfets/nfe/domain/entities/nfe/inf-nfe/det/rastro';
import type { InfProdNFF as IInfProdNFF } from '@nfets/nfe/domain/entities/nfe/inf-nfe/det/infprod-nff';
import type { InfProdEmb as IInfProdEmb } from '@nfets/nfe/domain/entities/nfe/inf-nfe/det/infprod-emb';
