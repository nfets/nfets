...
import type { IPITrib as IIPITrib } from '@nfets/nfe/domain/entities/nfe/inf-nfe/det/imposto/ipi';
import type { IPINT as IIPINT } from '@nfets/nfe/domain/entities/nfe/inf-nfe/det/imposto/ipi';
