  ...
  SVRS: {
    [Environment.Homolog]: {
      NfeStatusServico: {
        ...
        operation: 'NFeStatusServico4',
        version: '4.00',
        url: 'https://nfe-2.svrs.rs.gov.br/ws/NfeStatusServico/NfeStatusServico4.asmx',
      },
      NfeAutorizacao: {
        method: 'nfeAutorizacaoLote',
        operation: 'NFeAutorizacao4',
        version: '4.00',
        url: 'https://nfe-2.svrs.rs.gov.br/ws/NfeAutorizacao/NFeAutorizacao4.asmx',
      },
      NfeConsultaProtocolo: {
        method: 'nfeConsultaNF',
        operation: 'NFeConsultaProtocolo4',
        version: '4.00',
        url: 'https://nfe-2.svrs.rs.gov.br/ws/NfeConsulta/NfeConsulta4.asmx',
      },
      NfeInutilizacao: {
        method: 'nfeInutilizacaoNF',
        operation: 'NFeInutilizacao4',
        version: '4.00',
        url: 'https://nfe-2.svrs.rs.gov.br/ws/nfeinutilizacao/nfeinutilizacao4.asmx',
      },
      NfeRetAutorizacao: {
        method: 'nfeRetAutorizacaoLote',
        operation: 'NFeRetAutorizacao4',
        version: '4.00',
        url: 'https://nfe-2.svrs.rs.gov.br/ws/NfeRetAutorizacao/NFeRetAutorizacao4.asmx',
      },
      RecepcaoEvento: {
        method: 'nfeRecepcaoEvento',
        operation: 'NFeRecepcaoEvento4',
        version: '1.00',
        url: 'https://nfe-2.svrs.rs.gov.br/ws/recepcaoevento/recepcaoevento4.asmx',
      },
      NfeConsultaCadastro: {
        method: 'consultaCadastro4',
        operation: 'CadConsultaCadastro4',
