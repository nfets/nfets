...
<NFe xmlns="http://www.portalfiscal.inf.br/nfe">
  ...
  it('should build NFe with ISSQN imposto and ISSQNtot and ICMSTot using ISSQNtot and ICMSTot methods', async () => {
    const builder = NfeXmlBuilder.create(toolkit)
      .infNFe({ versao: '4.00' })
      .ide(createValidIde())
      .emit(createValidEmit())
      ...
      .ISSQNtot({ dCompet: '2025-06-12' })
      .ICMSTot({ vBC: '100.00', vICMS: '10.00' })
      .transp(createValidTransp())
      .pag(createValidPag());
...
<NFe xmlns="http://www.portalfiscal.inf.br/nfe">
  ...
  it('should build NFe with multiple det elements', async () => {
    const builder = NfeXmlBuilder.create(toolkit)
      .infNFe({ versao: '4.00' })
      .ide(createValidIde())
      .emit(createValidEmit())
      .det([...createValidItems(), ...createValidItems()], (ctx, item) =>
        ctx
          .prod({
            cProd: item.code,
            cEAN: 'SEM GTIN',
...
<NFe xmlns="http://www.portalfiscal.inf.br/nfe">
  ...
  it('Should not generate PL_010 tags when using PL_09', async () => {
    const builder = NfeXmlBuilder.create(toolkit)
      .infNFe({ versao: '4.00' })
      .ide(createValidIde())
      .emit(createValidEmit())
