...
import { expectIsRight } from 'test/expects';

describe('node certificate repository (unit)', () => {
  const password = '123456',
    validCnpjPfxCertificate = path.resolve(
      'test/fixtures/certificates/certificate_79839601000142.pfx',
    ),
    validCpfPfxCertificate = path.resolve(
      'test/fixtures/certificates/certificate_61094730068.pfx',
    );
