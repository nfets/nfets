import { StateCodeSeValidator } from '@nfets/core/application/validations/state-code/strategies/state-code-se-validator';
...
describe('StateCodeSeValidator', () => {
  ...
  it('should invalidate IE with wrong check digit when digit === 10 or 11', () => {
    ...
    expect(validator.execute('270000001')).toBe(false);
  });
