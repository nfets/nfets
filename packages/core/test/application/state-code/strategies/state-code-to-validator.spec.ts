import { StateCodeToValidator } from '@nfets/core/application/validations/state-code/strategies/state-code-to-validator';
...
describe('StateCodeToValidator', () => {
  ...
  it('should invalidate IE with wrong check digit when remainder < 2', () => {
    ...
    expect(validator.execute('29000000001')).toBe(false);
  });
